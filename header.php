...
<html lang="pt-BR">
    <head>
        ...
        <meta name="description" content="Atacamix" />
        <meta name="keywords" content="" />
        <meta name="robots" content="index,follow,noodp">
        <meta name="googlebot" content="index,follow">
        <meta name="subject" content="Atacamix">
        <meta name="abstract" content="Atacamix">
        <meta name="topic" content="Atacamix">
        <meta name="summary" content="Atacamix">
        <meta property="og:url" content="">
        <meta property="og:type" content="website">
        <meta property="og:title" content="Atacamix">
        <meta property="og:image" content="<?php echo get_template_directory_uri(); ?>/assets/images/favicon/android-icon-192x192.png">
        <meta property="og:description" content="Atacamix">
        <meta property="og:site_name" content="Atacamix">
        <meta property="og:locale" content="pt_BR">
        <meta itemprop="name" content="Atacamix">
        <meta itemprop="description" content="Atacamix">
        <meta itemprop="image" content="<?php echo get_template_directory_uri(); ?>/assets/images/favicon/android-icon-192x192.png">
        <meta name="twitter:card" content="summary">
        <meta name="twitter:site" content="">
        <meta name="twitter:url" content="">
        <meta name="twitter:title" content="Atacamix">
        <meta name="twitter:description" content="Atacamix">
        <meta name="twitter:image" content="<?php echo get_template_directory_uri(); ?>/assets/images/favicon/android-icon-192x192.png">
        ...
        <meta name="msapplication-TileColor" content="#333367">
        ...
        <title>Atacamix</title>

        <link rel="icon" href="<?php echo get_template_directory_uri(); ?>/assets/images/favicon/android-icon-192x192.png" type="image/x-icon" />
